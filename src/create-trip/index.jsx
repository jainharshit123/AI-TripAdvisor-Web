...
const CreateTrip = () => {
  ...
  const OnGeneratetrip = async () => {
    ...
    if (formData?.noOfDays > 5) {
      toast.error("Failed to generate trip! Plan your trip for maximum 5 days");
      return;
    }
    if (
      !formData?.location ||
  ...
  return (
    <div className="flex flex-col items-center w-11/12 sm:px-10 md:px-32 lg:px-56 xl:px-10 px-5 mt-10">
